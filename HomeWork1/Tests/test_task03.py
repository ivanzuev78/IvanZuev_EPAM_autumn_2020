...
class TestTask03(unittest.TestCase):
    ...
    def test_find_maximum_and_minimum(self):
        self.assertEqual(find_maximum_and_minimum('data_test_task03_min1_max9.txt'), (1, 9))
        self.assertEqual(find_maximum_and_minimum('data_test_task03_min-10_max19.txt'), (-10, 19))
        self.assertEqual(find_maximum_and_minimum('data_test_task03_min1_max1.txt'), (1, 1))
